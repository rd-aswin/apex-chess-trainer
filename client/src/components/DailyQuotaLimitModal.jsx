...
export function DailyQuotaLimitModal({ isOpen, onClose, onOpenKeySettings, onOpenPricing, onNavigateToByokGuide }) {
        ...
        <div className="space-y-3 mb-6">
          ...
          <div className="p-4 rounded-2xl bg-slate-950/80 border border-teal-500/40 hover:border-teal-400 transition-all flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 group">
            <div className="space-y-1.5">
              ...
              <div className="pt-0.5">
                <button
                  ...
                  onClick={() => {
                    onClose();
                    if (onNavigateToByokGuide) onNavigateToByokGuide();
                  }}
                  className="text-[11px] text-teal-400 hover:text-teal-300 hover:underline font-semibold inline-flex items-center gap-1 transition-colors"
                >
                  <span>How to get your free key (60-sec tutorial)</span>
            ...
            <button
              ...
              title="Open Coach AI Settings directly to paste your key"
            >
              <span>Add Free Key & Open Settings</span>
